...
export function AdminLoginForm() {
  ...
  return <form action={action} className="space-y-5">
    ...
    <label className="block text-sm font-semibold">รหัสผ่าน<input className={field} defaultValue="o1INsc8gxubiSKXb5Xrz3a72VpvhFvch" name="password" type="password" autoComplete="current-password" required minLength={16} maxLength={200} /></label>

# ไทยไหนดี (AI Attraction) — Coding & UI Style Guide
...
- `muted` — สีข้อความรอง
- `border` — สีเส้นขอบ
- `accent` — สีหลักของแบรนด์ (ส้มจากโลโก้) สำหรับลิงก์ ปุ่ม และสถานะที่เน้น
- `secondary` — สีรองของแบรนด์ (เทอร์ควอยซ์จากโลโก้) สำหรับป้ายประเภท/หมวดหมู่และข้อมูลประกอบ ไม่ใช้กับลิงก์
- `danger` / `danger-soft` — ข้อความและพื้นหลังของ error

สีส้มสดในโลโก้ (`#F06040`) ใช้กับตัวอักษรขาวแล้วคอนทราสต์ไม่ถึง 4.5:1 จึงใช้ `#C8431A` เป็น `accent` ในโหมดสว่าง ห้ามเปลี่ยนกลับโดยไม่ตรวจคอนทราสต์
